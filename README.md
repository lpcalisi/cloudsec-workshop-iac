# What is IAC?
Nowadays, most of the users create their infrastructure resources manually, it creates some problems when you want to replicate or modify the infrastructure, having the chance to enter errors or not knowing exactly wich resources form parts of it.
